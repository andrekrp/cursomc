...
import com.reguse.cursomc.domain.ItemPedido;
import com.reguse.cursomc.domain.Pagamento;
import com.reguse.cursomc.domain.PagamentoComBoleto;
import com.reguse.cursomc.domain.PagamentoComCartao;
import com.reguse.cursomc.domain.Pedido;
import com.reguse.cursomc.domain.Produto;
import com.reguse.cursomc.domain.enums.EstadoPagamento;
...
import com.reguse.cursomc.repositories.ItemPedidoRepository;
import com.reguse.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pagto01 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto01);

		Pagamento pagto02 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"),
				null);
		ped2.setPagamento(pagto02);
